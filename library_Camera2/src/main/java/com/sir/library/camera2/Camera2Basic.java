...
public class Camera2Basic {
    ...
    private String TAG = "Camera2Basic";


    private Context context;

    private Camera2Callback cameraCallback;
     ...
     */
    public void setCameraCallback(Camera2Callback cameraCallback) {
    ...
    public void selectCamera(String id) {
        ...
        try {
            ...
            if (map != null) {
                ...
                Log.i("TAG", "previewSize Width;" + previewSize.getWidth());
                Log.i("TAG", "previewSize Height;" + previewSize.getHeight());
            } else {
    ...
    private void startBackgroundThread() {
        backgroundThread = new HandlerThread("Camera2Basic");
    ...
    /**
     * 设置CaptureRequest参数以进行预览，例如, 闪光灯，自动对焦，微距模式等
     *
    ...
    /**
     * 调用stopPreview()然后startPreview()的快捷方式
     */
